...
public class ShooterRPMDistance extends Command{
    ...
    public ShooterRPMDistance(ShooterSubsystem shooterSubsystem, FeederSubsystem feederSubsystem, VisionSubsystem visionSubsystem, SwerveSubsystem swerveSubsystem, double speed_feeder){
    ...
    @Override
    public void execute() {
        Transform2d offset = this.swerveSubsystem.getPose().minus(new Pose2d(11.920,4.021,Rotation2d.kZero));
